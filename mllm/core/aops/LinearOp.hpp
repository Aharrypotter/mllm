...
inline LinearImplTypes str2LinearImplTypes(const std::string& str) {
  static const std::unordered_map<std::string, LinearImplTypes> map = {
      ...
      {"MllmBlas_KAI_SGEMM_NT_NT_NEON", LinearImplTypes::kMllmBlas_KAI_SGEMM_NT_NT_NEON},
      {"MllmBlas_KAI_SGEMM_NT_T_SME", LinearImplTypes::kMllmBlas_KAI_SGEMM_NT_T_SME},
...
inline std::string LinearImplTypes2Str(LinearImplTypes type) {
  static const std::unordered_map<LinearImplTypes, std::string> map = {
      ...
      {LinearImplTypes::kMllmBlas_KAI_SGEMM_NT_NT_NEON, "MllmBlas_KAI_SGEMM_NT_NT_NEON"},
      {LinearImplTypes::kMllmBlas_KAI_SGEMM_NT_T_SME, "MllmBlas_KAI_SGEMM_NT_T_SME"},
